...
public class T1_DoubleClick {
    ...
    public void t1_double_click_test(){
        ...
        DoubleClickPage agreeButton = new DoubleClickPage();
        agreeButton.agreeBtn.click();
        ...
        String expectedInAttribute ="red";

        Assert.assertTrue(actualStyleAttributeValue.contains(expectedInAttribute));
        //NOTE: FOLLOW POM
    }
}
